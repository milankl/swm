...
#include "parallel_sparsetools_impl.h"

#if PY_VERSION_HEX >= 0x03000000
static struct PyModuleDef moduledef = {
    PyModuleDef_HEAD_INIT,
    "_parallel_sparsetools",
    NULL,
    -1,
    sparsetools_methods,
    NULL,
...
PyObject *PyInit__parallel_sparsetools(void)
{
    PyObject *m;
...
#else
PyMODINIT_FUNC init_parallel_sparsetools(void) {
    PyObject *m;
    m = Py_InitModule("_parallel_sparsetools", sparsetools_methods);
    import_array();
    if (m == NULL) {
        Py_FatalError("can't initialize module _parallel_sparsetools");
    }
}
#endif
